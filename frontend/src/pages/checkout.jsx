...
//     const shipping = subtotal > 0 ? 250 : 0; // example flat shipping fee
...
//                     </div>
//                     <div>
//                         <p>Fill in Your Detail to Finalize Your Purchase</p>
//                     </div>
//                 </div>
//             </header>
...
//                                 <a href="/login" className="text-blue-600 text-sm">Sign in</a>
//                             </div>
//                             <input
//                                 type="email"
//                                 name="email"
...
//                             <label className="flex items-center justify-between p-4 border-2 border-blue-500 rounded-md mb-3 cursor-pointer bg-blue-50">
...
//                                     />
//                                     <div className="ml-3">
//                                         <div className="font-medium">FLAT SHIPPING 249 PKR + FBR POS FEE 1 PKR</div>
//                                         <div className="text-sm text-gray-600">Cash on Delivery (COD)</div>
//                                     </div>
//                                 </div>
//                                 <span className="font-semibold">Rs 250.00</span>
//                             </label>

//                             <label className="flex items-center justify-between p-4 border border-gray-300 rounded-md cursor-pointer">
//                                 <div className="flex items-center">
//                                     <input
//                                         type="radio"
//                                         name="shippingMethod"
...
//                                     />
//                                     <div className="ml-3">
//                                         <div className="font-medium">FREE SHIPPING + FBR POS FEE 1 PKR</div>
//                                         <div className="text-sm text-gray-600">Debit - Credit Card</div>
//                                     </div>
//                                 </div>
//                                 <div className="text-right">
//                                     <div className="text-sm text-gray-500 line-through">Rs 250.00</div>
...
//                             <label className="flex items-center p-4 border-2 border-blue-500 rounded-t-md cursor-pointer bg-blue-50">
//                                 <input
//                                     type="radio"
//                                     name="paymentMethod"
//                                     value="cod"
...
//                             <label className="flex items-center justify-between p-4 border border-t-0 border-gray-300 rounded-b-md cursor-pointer">
//                                 <div className="flex items-center">
//                                     <input
//                                         type="radio"
//                                         name="paymentMethod"
...
//                             <label className="flex items-center p-4 border-2 border-blue-500 rounded-md mb-3 cursor-pointer bg-blue-50">
//                                 <input
//                                     type="radio"
//                                     name="billingAddress"
//                                     value="same"
...
//                                     className="w-4 h-4 text-blue-600"
//                                 />
//                                 <span className="ml-3 font-medium">Use a different billing address</span>
//                             </label>
//                         </div> */}

//                         <button
//                             onClick={handleSubmit}
//                             className="w-full bg-blue-600 text-white py-4 rounded-md font-semibold hover:bg-blue-700 transition-colors"
//                         >
//                             Complete order
//                         </button>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm">
                        ...
                        <div className="mb-8">
                            <div className="flex justify-between items-center mb-4">
                                <h2 className="text-xl font-semibold">Contact</h2>
                                <a href="/login" className="text-blue-600 text-sm hover:underline">Sign in</a>
                            </div>
                            <input
                                type="email"
                                name="email"
